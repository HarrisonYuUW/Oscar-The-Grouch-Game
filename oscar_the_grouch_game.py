...
def intro():
    ...
    while not start:
        ...
        font = pygame.font.SysFont('Calibri', 15, True, False)
        text = font.render("ARROW KEYS - UP/DOWN/LEFT/RIGHT",True,GREEN)
        screen.blit(text, [215, 325-35]) 
        font = pygame.font.SysFont('Calibri', 15, True, False)
        text = font.render("1, 2, 3, 4, SPACE - TELEPORT",True,GREEN)
        screen.blit(text, [250, 340-35]) 
        font = pygame.font.SysFont('Calibri', 15, True, False)
        text = font.render("Q/W - PAUSE/RESUME",True,GREEN)
